 ...
 * @LastEditTime: 2024-08-28 14:01:54
 * @FilePath: /Reactor/src/client.cpp
 ...
 * @Date: 2024-07-24 14:15:40
 * @LastEditors: runwiththewind23 19945243142@163.com
 * @LastEditTime: 2024-08-28 13:41:55
 * @FilePath: /sxd/reactor/reactor/Reactor/src/client.cpp
 * @Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置
 * 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 */
// 网络通讯的客户端程序。
...
int main(int argc, char *argv[]) {
  if (argc != 3) {
    ...
    printf("example:./client 10.0.16.10 5080\n\n");
    return -1;
  }
